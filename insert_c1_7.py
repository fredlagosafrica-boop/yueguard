#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insert c1_7 (客户关系维护) into ifa_content.js after c1_4"""

TARGET = '/home/lenovo12348/.openclaw/workspace/yueguard/ifa_content.js'

# Each article body uses <br> for line breaks (matching existing entries)
articles = [
    {
        'id': 'ifa_1_7_1',
...
marker = "{ id: 'ifa_1_10_5'"
pos = content.find(marker)
if pos == -1:
    print("ERROR: ifa_1_10_5 marker not found")
    import sys; sys.exit(1)

new_content = content[:pos] + c1_7_block + content[pos:]

with open(TARGET, 'w', encoding='utf-8') as f:
    f.write(new_content)

print("OK! c1_7 inserted successfully")